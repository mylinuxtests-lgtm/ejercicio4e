...
if (
    empty($nombre) || empty($sexo) || empty($edad) ||
    empty($bday) || empty($country) || empty($photo_) ||
    empty($telefono) || empty($correo) || empty($domicilio) ||
    empty($list) || empty($excel)
) {
